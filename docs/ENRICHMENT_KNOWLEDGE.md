...
## Retail Data catalogues

Licensed Retail Data sources are valuable product inputs, but their
descriptions, images and catalogue feeds are not training data by
...
2. a client-provided licensed Retail Data export;
3. explicit written permission from the catalogue owner.

Retail Data facts must retain an approved internal source reference, retrieval
time, market and language. Claims remain attributed catalogue claims rather than objective facts.
...
2. Add authorized Retail Data connectors behind a common provenance contract.
